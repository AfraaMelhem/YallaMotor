...
@push('styles')
    ...
    <!-- DATA TABLES CSS -->
    <link rel="stylesheet" href="{{ asset('build/assets/cdn.datatables.net/1.12.1/css/dataTables.bootstrap5.min.css') }}">
    <link rel="stylesheet" href="{{ asset('build/assets/cdn.datatables.net/responsive/2.3.0/css/responsive.bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('build/assets/cdn.datatables.net/buttons/2.2.3/css/buttons.bootstrap5.min.css') }}">
                        ...
                        <div class="card-body">
                            <div class="deleted-table table-responsive">
                                <div class="text-center">
                                    <button id="button" class="btn btn-primary mb-2 data-table-btn">Delete selected
                                        row</button>
                                </div>
...
@push('scripts')
    <!-- DATATABLES CDN JS -->
    <script src="{{ asset('build/assets/cdn.datatables.net/1.12.1/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('build/assets/cdn.datatables.net/1.12.1/js/dataTables.bootstrap5.min.js') }}"></script>
    <script src="{{ asset('build/assets/cdn.datatables.net/responsive/2.3.0/js/dataTables.responsive.min.js') }}"></script>
    <script src="{{ asset('build/assets/cdn.datatables.net/buttons/2.2.3/js/dataTables.buttons.min.js') }}"></script>
    <script src="{{ asset('build/assets/cdn.datatables.net/buttons/2.2.3/js/buttons.print.min.js') }}"></script>
    <script src="{{ asset('build/assets/cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.6/pdfmake.min.js') }}"></script>
    <script src="{{ asset('build/assets/cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/vfs_fonts.js') }}"></script>
    <script src="{{ asset('build/assets/cdn.datatables.net/buttons/2.2.3/js/buttons.html5.min.js') }}"></script>
    <script src="{{ asset('build/assets/cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js') }}"></script>
