                                ...
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a class="dropdown-item" href="javascript:void(0);">Today</a>
                                            </li>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center fw-semibold">
                                                        <span class="avatar avatar-sm me-2 avatar-rounded">
                                                            <img src="build/assets/images/faces/11.jpg"
                                                                alt="img">
                                                        </span>Simon Cowel
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center fw-semibold">
                                                        <span class="avatar avatar-sm me-2 avatar-rounded">
                                                            <img src="build/assets/images/faces/8.jpg"
                                                                alt="img">
                                                        </span>Mirinda Hers
                                                    </div>
                                                </td>
                                ...
                                <div class="card custom-card">
                                    ...
                                    <div class="card-body p-0 overflow-hidden">
                                        <div
                                            ...
                                            <canvas id="leads-source"
                                                class="chartjs-chart w-100 p-4"></canvas>
                                            ...
                                            <ul class="list-unstyled mb-0 crm-recent-activity">
                                                        ...
                                                        <div class="crm-timeline-content">
                                                            <span class="fw-semibold">Update of calendar events
                                                                &amp;</span><span><a href="javascript:void(0);"
                                                                    class="text-primary fw-semibold"> Added new
                                                ...
                                                <li class="crm-recent-activity-content">
                                                    <div class="d-flex align-items-top">
                                                        ...
                                                        <div class="crm-timeline-content">
                                                            <span>New theme for <span
                                                                    class="fw-semibold">Spruko Website</span>
                                                                completed</span>
                                                ...
                                                <li class="crm-recent-activity-content">
                                                    <div class="d-flex align-items-top">
                                                        ...
                                                        <div class="crm-timeline-content">
                                                            <span>Created a <span
                                                                    class="text-success fw-semibold">New
